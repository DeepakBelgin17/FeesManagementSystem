...
public class SearchRecord extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        tbl_studentdata.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Receipt No", "Rollno", "Student name", "games", "payment mode", "amount", "remark"
            }
        ));
        jScrollPane1.setViewportView(tbl_studentdata);

        jPanel1.add(jScrollPane1, new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 190, 880, 390));

        jLabel1.setFont(new java.awt.Font("Tahoma", 1, 25)); // NOI18N
        jLabel1.setForeground(new java.awt.Color(255, 255, 255));
        jLabel1.setText("Search Record");
        jPanel1.add(jLabel1, new org.netbeans.lib.awtextra.AbsoluteConstraints(370, 30, 200, -1));
        ...
        jPanel1.add(txt_search, new org.netbeans.lib.awtextra.AbsoluteConstraints(410, 90, 350, 30));

        getContentPane().add(jPanel1, new org.netbeans.lib.awtextra.AbsoluteConstraints(370, 0, 1190, 720));

        setSize(new java.awt.Dimension(1585, 995));
